      ...
      return (
        <div>
          ...
          <p>
            ...
            interface for all interactions with the rNex protocol.
          </p>
          <p>
            {' '}
            Development will be on going, and rNexclassic will still exist in
            the interim as we work to get Omakase Bar completely polished.
          </p>
        </div>
      )
    } else {
